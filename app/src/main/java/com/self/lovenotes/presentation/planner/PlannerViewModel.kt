...
class PlannerViewModel @Inject constructor(
    ...
    // plan을 별도로 저장 (화면 전환용)
    private var _generatedPlan = MutableStateFlow("")
    val generatedPlan = _generatedPlan.asStateFlow()
...
//    fun closePlanScreen() { // 다이얼로그 대신 화면 닫기
//        _uiState.value = UiState.Idle
//    }

    fun clearPlan() {
        _uiState.value = UiState.Idle
        _generatedPlan.value = "" // plan 초기화
    }
